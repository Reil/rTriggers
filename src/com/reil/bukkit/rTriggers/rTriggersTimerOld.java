...
public class rTriggersTimerOld extends TimerTask{
	String [] Messages;
	rTriggers rTriggers;
	Timer timer;
	...
	public rTriggersTimerOld(rTriggers rTriggers, Timer timer, String [] Messages){
	...
	public rTriggersTimerOld() {
	}
	
	public rTriggersTimerOld clone(){
		rTriggersTimerOld clone = new rTriggersTimerOld();
	...
	public void run() {
		...
		// Shit bricks
		// Schedule next run
		rTriggersTimerOld clone = (rTriggersTimerOld) this.clone();
